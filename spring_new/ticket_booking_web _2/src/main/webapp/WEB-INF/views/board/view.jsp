			...
			<div class="container py-4 my-5">
				...
				<div class="d-grid">
					...
					<button type="button" class="btnReply"
						onclick="location.href='/app/board/comment?bulletin=${board.bulletin}&user_id=1&board_id=${board.board_id}&title=${board.title}&indent=${board.indent }&depthno=${board.depthno }'">답글</button>
