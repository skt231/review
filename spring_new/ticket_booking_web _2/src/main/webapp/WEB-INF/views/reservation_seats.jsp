...
<section class="d-flex">
	...
	<div class="main-content">
		...
		<header class="mobile-nav pt-4">
			<div class="container">
				<div class="row align-items-center">
					<div class="col-6">
						<a href="/app/"> <img src="images/logo.png" alt="">
						</a>
					</div>
		...
		<div class="container py-4 my-5">
			...
			title:${title}
		 <form id="reservationBtn" action="/app/reservation/payDetail" method="post"> 
	       ...
	       <input type="hidden" name="username" id="user" value="${userses.username}">
	         <input type="hidden" name="mt20id" id="mt20id" value="${mt20id}">
    		<input type="hidden" name="date" id="selectedDate" value="${date}">
    		<input type="hidden" name="location" id="selectedLocation" value="${location}">
    		<input type="hidden" name="time" id="selectedTime" value="${time}">
    		<input type="hidden" name="title" id="selectedTitle" value="${title}">
				<div class="stage">
					<h1>무대</h1>
				</div>
...
<script src="${pageContext.request.contextPath}/resources/js/imageModule.js" defer></script>
