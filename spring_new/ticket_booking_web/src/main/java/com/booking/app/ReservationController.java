...
public class ReservationController {
	...
	public String postSeat(@RequestParam("mt20id") String mt20id,
		...
		/*
		 * Class<?> variableClass=rsvdto.getRe_showdate().getClass();
		 * System.out.println("변수의 타입 : "+ variableClass.getName()); if
		 * (String.class.equals(variableClass)) {
		 * System.out.println("dd변수는 String 타입입니다."); } else if
		 * (Integer.class.equals(variableClass)) {
		 * System.out.println("dd변수는 Integer 타입입니다."); } else if
		 * (Date.class.equals(variableClass)) { System.out.println("dd변수는 Date 타입입니다.");
		 * } else { System.out.println("dd변수의 타입을 확인할 수 없습니다."); }
		 */
	...
	public String deleteRsv(@RequestParam("userid") Integer userid,
		...
		/* List<String> seatsList = Arrays.asList(re_selectedSeats.split(",")); */
