			...
			<div class="container py-4 my-5">
				<form class="form" method="post" action="/app/board/edit">
					<input type="hidden" name="${_csrf.parameterName}"
						...
						name='board_id' value="${board_id}"> <input type='hidden'
						name='page' value="${pageDto.page}"> <input type='hidden'
						name='perPageNum' value="${pageDto.perPageNum}"> <input
						type='hidden' name='searchType' value="${pageDto.searchType}">
					...
					<button type="submit" id="savebtn" class="btn btn-secondary">저장</button>
