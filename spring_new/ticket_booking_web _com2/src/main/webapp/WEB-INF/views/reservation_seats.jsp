			...
			<div class="col-md-12 m-30">
				...
				<form id="reservationBtn" action="/app/reservation/payDetail"
					...
					<input type="hidden" name="selectedSeats" id="selectedSeatsInput"
						value=""> <input type="hidden" name="totalAmount"
						id="totalAmountInput" value=""> <input type="hidden"
						name="username" id="username" value="${userses.username}">
					<input type="hidden" name="userid" id="userid"
						value="${userses.id}"> <input type="hidden" name="mt20id"
						id="mt20id" value="${mt20id}"> <input type="hidden"
						name="date" id="selectedDate" value="${date}"> <input
						type="hidden" name="location" id="selectedLocation"
