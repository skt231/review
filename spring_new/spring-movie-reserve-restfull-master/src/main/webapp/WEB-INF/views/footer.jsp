...
<body>
	<!-- 푸터 -->
	<div class="container-fluid pb-0 mb-0 justify-content-center text-light " id ="footer1">
		<footer>
			<div class="row my-5 justify-content-center py-5">
				<div class="col-11">
					<div class="row ">
						<div class="col-xl-8 col-md-4 col-sm-4 col-12 my-auto mx-auto a">
							<h3 class="text-muted mb-md-0 mb-5 bold-text">KOREA BOX</h3>
						</div>
						...
						<div class="col-xl-2 col-md-4 col-sm-4 col-12">
							...
							<p class="mb-1">146, Teheran-ro, Gangnam-gu, Seoul,Republic of Korea </p>
							<p></p>
						</div>
					</div>
					<div class="row ">
						<div
							...
							<p class="social text-muted mb-0 pb-0 bold-text">
								...
								<span class="mx-2"><i class="fa fa-youtube" aria-hidden="true"></i></span> 
							...
							<small class="rights"><span>&#174;</span>Today's special moments are tomorrow's memories.</small>
						</div>
						<div
